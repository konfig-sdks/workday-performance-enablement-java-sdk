...
public class BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 {
  ...
  public BusinessProcessParametersD396fd5bffec1000100f440bde4c0001() {
  }
  ...
  public BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 action(Action38ff08ab6736100010816009079d0126 action) {
  ...
  **/
  ...
  public BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 overallBusinessProcess(OverallBusinessProcess5d688bd57bb910001815ab49927724aa overallBusinessProcess) {
  ...
  **/
  ...
  public BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 comment(String comment) {
  ...
  **/
  ...
  public BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 transactionStatus(TransactionStatus7457adcbe0fa1000089b63ab3a510000 transactionStatus) {
  ...
  **/
  ...
  public BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 attachments(List<EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143> attachments) {
  ...
  public BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 addAttachmentsItem(EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143 attachmentsItem) {
  ...
  **/
  ...
  public BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 _for(For5d688bd57bb910001815ab3dd10024a9 _for) {
  ...
  **/
   ...
   * @return the BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 instance itself
   */
  public BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 businessProcessParametersD396fd5bffec1000100f440bde4c0001 = (BusinessProcessParametersD396fd5bffec1000100f440bde4c0001) o;
    return Objects.equals(this.action, businessProcessParametersD396fd5bffec1000100f440bde4c0001.action) &&
        Objects.equals(this.overallBusinessProcess, businessProcessParametersD396fd5bffec1000100f440bde4c0001.overallBusinessProcess) &&
        Objects.equals(this.comment, businessProcessParametersD396fd5bffec1000100f440bde4c0001.comment) &&
        Objects.equals(this.comments, businessProcessParametersD396fd5bffec1000100f440bde4c0001.comments) &&
        Objects.equals(this.transactionStatus, businessProcessParametersD396fd5bffec1000100f440bde4c0001.transactionStatus) &&
        Objects.equals(this.warningValidations, businessProcessParametersD396fd5bffec1000100f440bde4c0001.warningValidations) &&
        Objects.equals(this.overallStatus, businessProcessParametersD396fd5bffec1000100f440bde4c0001.overallStatus) &&
        Objects.equals(this.attachments, businessProcessParametersD396fd5bffec1000100f440bde4c0001.attachments) &&
        Objects.equals(this.criticalValidations, businessProcessParametersD396fd5bffec1000100f440bde4c0001.criticalValidations) &&
        Objects.equals(this._for, businessProcessParametersD396fd5bffec1000100f440bde4c0001._for)&&
        Objects.equals(this.additionalProperties, businessProcessParametersD396fd5bffec1000100f440bde4c0001.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BusinessProcessParametersD396fd5bffec1000100f440bde4c0001
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BusinessProcessParametersD396fd5bffec1000100f440bde4c0001.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 is not found in the empty JSON string", BusinessProcessParametersD396fd5bffec1000100f440bde4c0001.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BusinessProcessParametersD396fd5bffec1000100f440bde4c0001.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessProcessParametersD396fd5bffec1000100f440bde4c0001.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessProcessParametersD396fd5bffec1000100f440bde4c0001' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessProcessParametersD396fd5bffec1000100f440bde4c0001> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessProcessParametersD396fd5bffec1000100f440bde4c0001.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessProcessParametersD396fd5bffec1000100f440bde4c0001>() {
           @Override
           public void write(JsonWriter out, BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 value) throws IOException {
           ...
           @Override
           public BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessProcessParametersD396fd5bffec1000100f440bde4c0001
  * @throws IOException if the JSON string is invalid with respect to BusinessProcessParametersD396fd5bffec1000100f440bde4c0001
  */
  public static BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessProcessParametersD396fd5bffec1000100f440bde4c0001.class);
  }

 /**
  * Convert an instance of BusinessProcessParametersD396fd5bffec1000100f440bde4c0001 to an JSON string
  *
  * @return JSON string
  */
