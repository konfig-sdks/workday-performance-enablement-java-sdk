...
public class BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 {
  ...
  public BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000() {
  }
  ...
  public BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 action(Action38ff08ab6736100010816009079d0126 action) {
  ...
  **/
  ...
  public BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 overallBusinessProcess(OverallBusinessProcess5d688bd57bb910001815ab49927724aa overallBusinessProcess) {
  ...
  **/
  ...
  public BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 comment(String comment) {
  ...
  **/
  ...
  public BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 transactionStatus(TransactionStatus7457adcbe0fa1000089b63ab3a510000 transactionStatus) {
  ...
  **/
  ...
  public BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 attachments(List<EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143> attachments) {
  ...
  public BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 addAttachmentsItem(EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143 attachmentsItem) {
  ...
  **/
  ...
  public BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 _for(For5d688bd57bb910001815ab3dd10024a9 _for) {
  ...
  **/
   ...
   * @return the BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 instance itself
   */
  public BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 businessProcessParameters2b4c8a6ca069100035b85907ae2c0000 = (BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000) o;
    return Objects.equals(this.action, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000.action) &&
        Objects.equals(this.overallBusinessProcess, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000.overallBusinessProcess) &&
        Objects.equals(this.comment, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000.comment) &&
        Objects.equals(this.comments, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000.comments) &&
        Objects.equals(this.transactionStatus, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000.transactionStatus) &&
        Objects.equals(this.warningValidations, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000.warningValidations) &&
        Objects.equals(this.overallStatus, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000.overallStatus) &&
        Objects.equals(this.attachments, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000.attachments) &&
        Objects.equals(this.criticalValidations, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000.criticalValidations) &&
        Objects.equals(this._for, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000._for)&&
        Objects.equals(this.additionalProperties, businessProcessParameters2b4c8a6ca069100035b85907ae2c0000.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 is not found in the empty JSON string", BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000>() {
           @Override
           public void write(JsonWriter out, BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 value) throws IOException {
           ...
           @Override
           public BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000
  * @throws IOException if the JSON string is invalid with respect to BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000
  */
  public static BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000.class);
  }

 /**
  * Convert an instance of BusinessProcessParameters2b4c8a6ca069100035b85907ae2c0000 to an JSON string
  *
  * @return JSON string
  */
