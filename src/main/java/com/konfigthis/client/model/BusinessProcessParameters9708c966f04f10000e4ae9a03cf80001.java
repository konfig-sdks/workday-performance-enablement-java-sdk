...
public class BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 {
  ...
  public BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001() {
  }
  ...
  public BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 action(Action38ff08ab6736100010816009079d0126 action) {
  ...
  **/
  ...
  public BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 overallBusinessProcess(OverallBusinessProcess5d688bd57bb910001815ab49927724aa overallBusinessProcess) {
  ...
  **/
  ...
  public BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 comment(String comment) {
  ...
  **/
  ...
  public BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 transactionStatus(TransactionStatus7457adcbe0fa1000089b63ab3a510000 transactionStatus) {
  ...
  **/
  ...
  public BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 attachments(List<EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143> attachments) {
  ...
  public BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 addAttachmentsItem(EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143 attachmentsItem) {
  ...
  **/
  ...
  public BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 _for(For5d688bd57bb910001815ab3dd10024a9 _for) {
  ...
  **/
   ...
   * @return the BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 instance itself
   */
  public BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 businessProcessParameters9708c966f04f10000e4ae9a03cf80001 = (BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001) o;
    return Objects.equals(this.action, businessProcessParameters9708c966f04f10000e4ae9a03cf80001.action) &&
        Objects.equals(this.overallBusinessProcess, businessProcessParameters9708c966f04f10000e4ae9a03cf80001.overallBusinessProcess) &&
        Objects.equals(this.comment, businessProcessParameters9708c966f04f10000e4ae9a03cf80001.comment) &&
        Objects.equals(this.comments, businessProcessParameters9708c966f04f10000e4ae9a03cf80001.comments) &&
        Objects.equals(this.transactionStatus, businessProcessParameters9708c966f04f10000e4ae9a03cf80001.transactionStatus) &&
        Objects.equals(this.warningValidations, businessProcessParameters9708c966f04f10000e4ae9a03cf80001.warningValidations) &&
        Objects.equals(this.overallStatus, businessProcessParameters9708c966f04f10000e4ae9a03cf80001.overallStatus) &&
        Objects.equals(this.attachments, businessProcessParameters9708c966f04f10000e4ae9a03cf80001.attachments) &&
        Objects.equals(this.criticalValidations, businessProcessParameters9708c966f04f10000e4ae9a03cf80001.criticalValidations) &&
        Objects.equals(this._for, businessProcessParameters9708c966f04f10000e4ae9a03cf80001._for)&&
        Objects.equals(this.additionalProperties, businessProcessParameters9708c966f04f10000e4ae9a03cf80001.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 is not found in the empty JSON string", BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001>() {
           @Override
           public void write(JsonWriter out, BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 value) throws IOException {
           ...
           @Override
           public BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001
  * @throws IOException if the JSON string is invalid with respect to BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001
  */
  public static BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001.class);
  }

 /**
  * Convert an instance of BusinessProcessParameters9708c966f04f10000e4ae9a03cf80001 to an JSON string
  *
  * @return JSON string
  */
