...
public class BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf {
  ...
  public BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf() {
  }
  ...
  public BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf action(Action38ff08ab6736100010816009079d0126 action) {
  ...
  **/
  ...
  public BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf overallBusinessProcess(OverallBusinessProcess5d688bd57bb910001815ab49927724aa overallBusinessProcess) {
  ...
  **/
  ...
  public BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf comment(String comment) {
  ...
  **/
  ...
  public BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf transactionStatus(TransactionStatus7457adcbe0fa1000089b63ab3a510000 transactionStatus) {
  ...
  **/
  ...
  public BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf attachments(List<EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143> attachments) {
  ...
  public BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf addAttachmentsItem(EventAttachmentsForToolbar43b30ba735b8100011ee4767246d0143 attachmentsItem) {
  ...
  **/
  ...
  public BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf _for(For5d688bd57bb910001815ab3dd10024a9 _for) {
  ...
  **/
   ...
   * @return the BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf instance itself
   */
  public BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf = (BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf) o;
    return Objects.equals(this.action, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.action) &&
        Objects.equals(this.overallBusinessProcess, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.overallBusinessProcess) &&
        Objects.equals(this.comment, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.comment) &&
        Objects.equals(this.comments, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.comments) &&
        Objects.equals(this.transactionStatus, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.transactionStatus) &&
        Objects.equals(this.warningValidations, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.warningValidations) &&
        Objects.equals(this.overallStatus, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.overallStatus) &&
        Objects.equals(this.attachments, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.attachments) &&
        Objects.equals(this.criticalValidations, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.criticalValidations) &&
        Objects.equals(this._for, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf._for)&&
        Objects.equals(this.additionalProperties, businessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf is not found in the empty JSON string", BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf>() {
           @Override
           public void write(JsonWriter out, BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf value) throws IOException {
           ...
           @Override
           public BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf
  * @throws IOException if the JSON string is invalid with respect to BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf
  */
  public static BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf.class);
  }

 /**
  * Convert an instance of BusinessProcessParametersAfd6ac52d6251000117be546cb060000AllOf to an JSON string
  *
  * @return JSON string
  */
