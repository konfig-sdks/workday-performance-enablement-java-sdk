...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://<tenantHostname>/performanceEnablement/v5";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://<tenantHostname>/performanceEnablement/v5)
